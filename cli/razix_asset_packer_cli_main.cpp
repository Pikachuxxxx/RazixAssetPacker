...
int main(int argc, char* argv[])
{
    ...
    bool                                    result   = importer->importMesh("C:/Dev/Game Engines/Razix/Sandbox/Assets/Models/Sponza/Sponza.gltf", import_result, import_options);
    ...
    export_options.assetsOutputDirectory = "C:/Dev/Game Engines/Razix/Sandbox/Assets/";
    // Exporter
